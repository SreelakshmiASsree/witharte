        ...
        <>
            <div className="relative w-full h-screen">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-white">
                    ...
                    <div className="flex items-center lg:gap-5 gap-3 absolute lg:bottom-10 bottom-14">
                        <a href="https://www.instagram.com/witharte_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer">
                            <FaInstagram className="md:text-3xl text-xl text-[#ffffff]" />
                        </a>
                        <p className="text-[#ffffff] md:text-2xl text-lg font-medium flex items-center gap-1">
